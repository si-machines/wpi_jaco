  ...
  : arm_initialized (false)
{
  ...
  timed_trajectory_server_          = new TrajectoryServer( nh, topic_prefix_ + "_arm/timed_arm_controller/trajectory", boost::bind(&JacoArmTrajectoryController::execute_timed_trajectory, this,
                                                      _1), true);
